              ...
              <div className="flex flex-col gap-8 md:gap-40 lg:flex-row">
                <div className="flex flex-col gap-5">
                  ...
                  <p>
                    ...
                    <span>{contriesList?.region}</span>
                  </p>

                  <p>
                    <span className="font-semibold">Sub Region: </span>
                    <span>{contriesList?.subregion}</span>
                  </p>

                  <p>
                    <span className="font-semibold">Capital: </span>
                    <span>{contriesList?.capital}</span>
                  </p>
                </div>
                ...
                <div className="flex flex-col gap-5">
                  {/* <p>
                    ...
                    <span>{contriesList?.tld?.join(", ")}</span>
                  </p> */}
                  ...
                  {/* <p>
                    ...
                    <span className="font-thin">
                      {contriesList?.currencies &&
                        Object.keys(contriesList.currencies)
                          .map(
                            (currency) =>
                              `${contriesList?.currencies[currency].name}`,
                          )
                          .join(", ")}
                    </span>
                  </p> */}
                  ...
                  <p>
                    ...
                    <span className="font-thin">
                      {contriesList?.languages &&
                        Object.values(contriesList.languages)
                          .map((lang) => `${lang}`)
                          .join(", ")}
                    </span>
                  </p>
